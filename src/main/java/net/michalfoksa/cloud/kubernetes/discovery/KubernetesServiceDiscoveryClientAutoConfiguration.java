...
public class KubernetesServiceDiscoveryClientAutoConfiguration {

    private static final Log log = LogFactory.getLog(KubernetesServiceDiscoveryClient.class);

    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnProperty(name = "spring.cloud.kubernetes.service.discovery.enabled", matchIfMissing = true)
    public KubernetesServiceDiscoveryClient kubernetesDiscoveryClient(KubernetesClient client,
